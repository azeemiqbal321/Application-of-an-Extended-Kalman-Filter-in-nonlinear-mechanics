...
ndim=3;
n_meas=2; %We measure position as well as acceleration
dt=0.01; %time step

Q_variance=0.001; %process noise variance, assume a piecewise constant white noise
Q=piecewise_white_noise(3,Q_variance,dt);
Q=kron(Q,eye(1));

sensor_x_variance=0.01^2;
sensor_y_variance=0.14^2;
