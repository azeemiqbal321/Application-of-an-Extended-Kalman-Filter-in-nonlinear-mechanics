...
x=[0;1; 10; 10; 20]; %this is how the Kalman filter is initialized
P_max=10;
P=P_max*eye(5);
...
f={@(x1,x2,x3,x4,x5,t) (x1+x2*t);
   @(x1,x2,x3,x4,x5,t) (x2+(-x3*x2+x4^2*x1+x5*x1^3-AMP*cos(OMEG*t))*t)
   @(x1,x2,x3,x4,x5,t) (x3)  %gamma
   @(x1,x2,x3,x4,x5,t) (x4)  %k1
   @(x1,x2,x3,x4,x5,t) (x5)  %k2
   }; 
